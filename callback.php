 ...
 * 
 * This file handles payment notifications from Duitku and forwards them
 * to the JShopping payment processing system.
 * 
...
file_put_contents(__DIR__ . '/../../../../components/com_jshopping/log/duitku.log', $logData, FILE_APPEND);
...
file_put_contents(
    __DIR__ . '/../../../../components/com_jshopping/log/duitku.log',
